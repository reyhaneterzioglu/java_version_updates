...
public class CollectorsDemo {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> numberList2 = numbers.stream()
                .filter(x -> x % 2 == 0)
                .collect(Collectors.toList()); // same thing as above example numberList, shorter
        ...
        List<Integer> numberSet2 = numbers.stream()
                .filter(x -> x % 2 == 0)
                .collect(Collectors.toList()); // same thing as above example numberSet, shorter
        ...
        Double calorieAverage = DishData.getAll()
                .stream()
       ...
       Map<Type, List<Dish>> dishType = DishData.getAll()
                .stream()
